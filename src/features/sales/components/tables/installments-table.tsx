  ...
  const columns: ColumnDef<FinancingDetailInstallment>[] = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <span className="font-medium text-red-600">{formatCurrency(amount, currency)}</span>;
      },
    },
    {
      accessorKey: 'status',
      ...
      <CardContent>
        ...
        <div className="mb-4 grid gap-4 sm:grid-cols-4">
          <div className="rounded-lg border p-3">
            ...
            <p className="text-lg font-semibold">{formatCurrency(totals.total, currency)}</p>
          </div>
          ...
          {totals.lateFees > 0 && (
            <div className="rounded-lg border border-red-200 bg-red-50 p-3 dark:border-red-900 dark:bg-red-950">
              ...
              <p className="text-lg font-semibold text-red-700 dark:text-red-300">
                {formatCurrency(totals.lateFees, currency)}
              </p>
            </div>
          )}
        </div>
