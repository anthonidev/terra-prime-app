...
interface ClientsAdminFiltersProps {
  filters: {
    search?: string;
...
export function ClientsAdminFilters({ filters, onFiltersChange }: ClientsAdminFiltersProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
      ...
      <Select
        ...
        onValueChange={(value) => handleChange('collectorId', value === 'all' ? undefined : value)}
      >
        <SelectTrigger>
