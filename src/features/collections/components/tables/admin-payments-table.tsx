...
import { AdminPayment, StatusPayment } from '../../types';
...
const STORAGE_KEY = 'admin-payments-table-visibility';

interface AdminPaymentsTableProps {
  data: AdminPayment[];
}

export function AdminPaymentsTable({ data }: AdminPaymentsTableProps) {
