    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="px-4 sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Ingrese los detalles del comprobante de pago</DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmitHandler)} className="space-y-4">
          <div className="max-h-[calc(60vh)] overflow-y-auto">
              ...
              <div className="space-y-4">
                <div className="col-span-1 space-y-2 md:col-span-2">
                  ...
                  {errors.transactionDate && (
                    <p className="text-destructive text-sm">{errors.transactionDate.message}</p>
                  )}
                </div>
                <div className="col-span-1 space-y-2 md:col-span-2">
            ...
            <div className="col-span-1 space-y-2 pt-4 md:col-span-2">
              ...
              />
              {selectedFile && <p className="text-muted-foreground text-sm">{selectedFile.name}</p>}
