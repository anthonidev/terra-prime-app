...
import { Eye, EyeOff, Key, Loader2, Lock, Shield } from 'lucide-react';
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                Tu contraseña debe tener al menos 6 caracteres e incluir una mayúscula, una
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <Button type="submit" disabled={isChangingPassword || !form.formState.isValid}>
                {isChangingPassword ? (
                  <>
